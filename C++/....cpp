...
void intro(){
	gotoxy(12, 22);textcolor(13);printf("Made by: PHIEN");
	gotoxy(11, 23);textcolor(13);printf("Send to nguoiemthuong");
	for(int i=3; i>0; i--){
		gotoxy(50, 12);
		printf("%d", i);
		Sleep(1000);
...
int main(){
	...
	print(32, 9, 6000, " I don't know what my future holds,but i'm hoping you are in it");
	Sleep(15000);
	return 0;
}
